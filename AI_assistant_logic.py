...
class MedicalAssistant:
    ...
    def _get_system_prompt(self):
        ...
        return f"""
        You are an AI Support Assistant for MediScript AI,Greet if user Greets you first or says 'okay'/'okk' then say 'yeah'.
        ...
        *(Do not analyze, assume, or provide general facts.)*
        ...
        "This information is not available. Contact developer: chowdamvishnu@gmail.com"
